...
export const generateWithRetry = async (
    ...
    const defaultGeminiPreferences = ["gemini-2.5-flash", "gemini-2.0-flash", "gemini-2.5-flash"];
...
export const chatWithEmployeeAgent = async (
    ...
    try {
        ...
        const { text, modelUsed } = await generateWithRetry(
            `${context}\n\nUser Question: ${query}\n\nAnswer concisely.`,
            { preferredModels: ["gemini-2.5-pro", "gemini-1.5-pro", "gemini-2.5-flash", "gemini-2.0-flash", "gemini-2.5-flash"] },
