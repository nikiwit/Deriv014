...
type OnboardingMode = "form" | "ai" | "selection";
...
export const NewEmployeePage: React.FC<NewEmployeePageProps> = ({
  ...
  const [createdEmployee, setCreatedEmployee] =
    useState<InitialOnboardingJourney | null>(null);
  ...
  if (showSuccess && createdEmployee) {
    return (
      <div className="max-w-4xl mx-auto animate-fade-in py-8">
        ...
        <Card
          noPadding
          className="overflow-hidden shadow-2xl border-0 bg-white rounded-lg"
        >
          {/* Header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-sm border border-slate-200 flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-derivhr-600 uppercase tracking-wider">
                    AI Workflow Generated
                  </span>
                </div>
                <p className="text-slate-600 text-sm leading-relaxed line-clamp-2">
                  {createdEmployee.aiPlan
                    ? createdEmployee.aiPlan.substring(0, 150) + "..."
                    : "Standard compliance workflow activated."}
                </p>
  ...
  // Main Onboarding View (Form or AI)
  return (
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <Text variant="muted">
              Create a personalized onboarding journey for your new hire
            </Text>
          </div>
        </div>
