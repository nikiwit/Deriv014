  ...
  <Card className="hover:shadow-md transition-shadow">
    <div className="flex justify-between items-start mb-4">
      <div>
        ...
        <Heading level="h3" className="mt-1 !text-2xl">
          {value}
        </Heading>
      </div>
      <div
        className={`p-2 rounded-lg ${trendUp ? "bg-jade-50 text-jade-500" : "bg-red-50 text-red-600"}`}
      >
        {icon}
      </div>
    </div>
    <div className="flex items-center space-x-2">
      <span
        className={`text-xs font-bold ${trendUp ? "text-jade-500" : "text-red-600"}`}
      >
        {trend}
      </span>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <Text variant="muted" weight="medium">
            AI-driven insights into your workforce health.
          </Text>
        </div>
        <div className="flex items-center space-x-3">
          <Badge
            variant="success"
            className="px-3 py-1 text-xs uppercase tracking-wider gap-2"
          >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 bg-white rounded-lg p-3 border border-slate-200 shadow-sm">
            <div className="flex-1 flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                <Heading level="h4" className="!text-sm font-bold">
                  Start New Employee Journey
                </Heading>
                <Text size="sm" className="!text-xs text-slate-500">
                  AI-powered compliance and document automation.
                </Text>
              </div>
            </div>
        ...
        <Card className="lg:col-span-1 flex flex-col h-full">
          ...
          <div className="space-y-4 flex-1">
            <div className="p-5 rounded-lg bg-amber-50 border border-amber-100 hover:border-amber-300 transition-colors cursor-pointer group">
              ...
              >
                Based on Q3 hiring plans, you will exceed your foreign worker
                quota by <strong className="text-amber-900">5 pax</strong> in
                October.
              </Text>
              <button className="mt-3 text-sm font-bold text-amber-800 group-hover:underline">
            ...
            <div className="p-5 rounded-lg bg-red-50 border border-red-100 hover:border-red-200 transition-colors cursor-pointer group">
              ...
              <Text
                ...
                className="leading-relaxed !text-slate-800"
              >
                <strong className="text-slate-900">Ali Bin Ahmad</strong> hasn't
                taken annual leave in 8 months. Burnout risk elevated.
              </Text>
              <button className="mt-3 text-sm font-bold text-red-800 group-hover:underline">
                Draft "Take a Break" Email
              </button>
            </div>
            ...
            <div className="p-5 rounded-lg bg-jade-50 border border-jade-100 hover:border-jade-200 transition-colors cursor-pointer group">
              <div className="flex justify-between items-start mb-3">
                <span className="text-xs font-bold text-jade-800 uppercase tracking-widest">
                  Onboarding
                </span>
                <span className="text-xs text-jade-600 font-semibold">
                  Automated
                </span>
              </div>
              <Text
              ...
              >
                Offer accepted by{" "}
                <strong className="text-slate-900">Sarah Lee</strong>.
              </Text>
              <ul className="mt-3 space-y-2 text-sm text-jade-800 font-bold">
                <li className="flex items-center">
                  <CheckIcon /> Contract generated & sent
                </li>
                <li className="flex items-center">
                  <CheckIcon /> Laptop ordered (MacBook Pro)
                </li>
                <li className="flex items-center">
                  <CheckIcon /> Slack/Email provisioned
                </li>
              </ul>
            </div>
          </div>
