    ...
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans overflow-hidden">
      ...
      <aside className="w-64 bg-derivhr-dark flex flex-col z-20 shadow-2xl">
        <div className="p-6 flex items-center space-x-3 border-b border-white/5">
          <div className="w-8 h-8 bg-jade-500 rounded-lg flex items-center justify-center shadow-lg shadow-jade-500/20">
            <Zap className="text-white w-5 h-5 fill-current" />
          </div>
          <span className="text-xl font-black text-white tracking-tighter">
            Deriv<span className="text-jade-500">HR</span>
            <span className="text-[10px] text-slate-500 block font-bold tracking-widest uppercase">Employee Portal</span>
          </span>
        </div>
        ...
        <div className="p-4 border-b border-white/5">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-jade-500 to-jade-600 rounded-xl flex items-center justify-center text-white font-black text-sm shadow-lg">
              {user?.firstName?.[0]}{user?.lastName?.[0]}
            </div>
            <div className="flex-1">
              <p className="text-white font-bold text-sm">{user?.firstName} {user?.lastName}</p>
              <p className="text-slate-500 text-xs font-medium">{user?.department}</p>
            </div>
        ...
        <div className="p-4 border-t border-white/5 space-y-3">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center justify-center space-x-2 p-3 rounded-xl border border-white/10 hover:bg-red-500/10 hover:border-red-500/20 transition-all group"
          >
          ...
          <div className="bg-white/5 rounded-xl p-4 border border-white/5">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-[10px] font-black text-jade-500 uppercase tracking-widest">Secure Portal</span>
            </div>
            <p className="text-[11px] text-slate-500 leading-snug font-medium">
              Your data is encrypted and protected. Need help? Contact HR.
            </p>
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 overflow-auto relative bg-white">
         ...
         <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
            <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-jade-500/5 rounded-full blur-[120px]"></div>
